...
namespace CompGeomVis.delaunator
{
    // This code is mostly from https://github.com/nol1fe/delaunator-sharp
    // While this algorithm does work from the tool, the algorithm itself isn't instrumented
    // and wasn't broken down and analysed as part of the project.
    // Leaving this code here because it does work and will triangulate in the tool
    public class Delaunator : AlgorithmBase
    {
        ...
        //public IEnumerable<DelaunatorPoint> Points { get; private set; }
        ...
        private bool voronoiOperation = false;
            ...
            } else
            {
                ...
                foreach(var cell in GetVoronoiCells())
                {
                    ...
                    for(int i = 0; i < cell.Points.Count; i++)
                    {
                        ...
                        {
                            StartPoint = new Vector { X = sp.X, Y = sp.Y },
                            EndPoint = new Vector {  X = np.X, Y = np.Y }
                        });
                    }
